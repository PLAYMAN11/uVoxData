...
<div class="lh-header w-100 d-flex align-items-center justify-content-between px-3">
    ...
    <span class="lh-title" id="titulo-situacion">
        Situación
    </span>
...
<div id="selection-banner" style="
    ...
    font-weight: 600;
">
    Selección: <span id="selection-text"></span>
</div>
...
// Mostrar selección guardada del paso anterior
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (selection) {
        const title = document.getElementById('titulo-situacion');
